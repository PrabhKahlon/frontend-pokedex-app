        ...
        <div className="flex flex-col m-4">
            <Combobox value={selectedPokemon} onChange={setSelectedPokemon} >
                ...
                <div className="relative">
                    <div className="mt-2 max-h-60 absolute z-10 w-full ring-opacity-5 focus:outline-none shadow-lg ring-1 ring-black overflow-auto rounded-md bg-white text-base" ref={parentRef}>
